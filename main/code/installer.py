#!/usr/bin/env python3
"""
JARVIS v6.0 — Installer cross-platform
...
def create_start_script():
    ...
    if cmd_exists("ollama"):
        ...
        has_model = "jarvisQwen" in (r.stdout if r.returncode == 0 else "")
...
def main():
    print("═" * 54)
    print(f"{C.BOLD}{C.CYAN}🤖 JARVIS v6.0 — Installer{C.RESET}")
