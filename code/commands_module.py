...
def handle_add_voice(ctx: CommandContext, _arg: str = "") -> CommandResult:
    """OBSOLETO: /aggiungi_voce e' stato unificato in /profili_voce. Instrada li'."""
    return handle_list_voices(ctx, _arg)
...
def handle_list_voices(ctx: CommandContext, _arg: str = "") -> CommandResult:
    """Comando unico /profili_voce: aggiungi voce, togli una lingua, elimina
    account, reset PIN. Solo admin. La logica sta in user_registry.manage_voice."""
