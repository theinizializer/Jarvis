...
# ─── Costanti ─────────────────────────────────────────────────────────────────
# URL del server Ollama locale — di default gira sulla porta 11434
OLLAMA_DEFAULT_URL   = "http://localhost:11434/api/chat"
# Nome del modello Ollama da usare (puoi cambiarlo con qualsiasi modello installato)
OLLAMA_DEFAULT_MODEL = "jarvisQwen"
# URL di SearXNG locale (motore di ricerca self-hosted, raccomandato)
# Per avviarlo: docker run -d -p 8080:8080 searxng/searxng
SEARXNG_DEFAULT_URL  = "http://localhost:8080"
# Jina Reader: converte pagine web in testo puro, funziona anche con pagine JavaScript
JINA_BASE_URL        = "https://r.jina.ai/"
# API Wikipedia in italiano e inglese (completamente gratuite, nessuna chiave richiesta)
WIKIPEDIA_IT         = "https://it.wikipedia.org/w/api.php"
WIKIPEDIA_EN         = "https://en.wikipedia.org/w/api.php"
# Open-Meteo: API meteo gratuita senza registrazione
OPEN_METEO_URL       = "https://api.open-meteo.com/v1/forecast"
# Nominatim: geocoding gratuito di OpenStreetMap (converte nome città → lat/lon)
NOMINATIM_URL        = "https://nominatim.openstreetmap.org/search"
# Brave Search API — richiede BRAVE_API_KEY (imposta nell'env o tramite installer)
BRAVE_SEARCH_URL     = "https://api.search.brave.com/res/v1/web/search"
# GNews API — richiede GNEWS_API_KEY (piano gratuito disponibile su gnews.io)
GNEWS_URL            = "https://gnews.io/api/v4/"
# ANSA RSS: feed notizie italiano gratuito, usato come fallback se GNews non è configurato
ANSA_RSS             = "https://www.ansa.it/sito/notizie/topnews/topnews_rss.xml"
# DuckDuckGo HTML scraping: fallback di ricerca, nessuna chiave richiesta
DDG_HTML             = "https://html.duckduckgo.com/html/"

CACHE_TTL   = 300   # secondi prima che una ricerca in cache venga invalidata
MAX_CHARS   = 1200  # caratteri massimi estratti da una pagina web
MAX_RESULTS = 4     # numero massimo di URL da leggere per ogni ricerca
